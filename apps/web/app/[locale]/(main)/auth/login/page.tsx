...
import { useLoginMutation, useTelegramLoginMutation } from "@/hooks/use-auth"
...
export default function LoginPage() {
  ...
  const isLoading = isSubmitting || login.isPending || isRedirecting
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-3">
            <GoogleButton
              ...
              loading={googleAuthPending(isLoading)}
            />
...
function googleAuthPending(isLoading: boolean) {
  return isLoading
}
